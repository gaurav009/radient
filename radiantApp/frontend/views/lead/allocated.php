...
<p>
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="px-2 active"><a class="btn btn-default btn-sm" href="<?= Url::to(['/lead/allocated']) ?>">Allocated Tickets</a></li>
  ...
  <div class="tab-content">
    <div style="display: contents;" id="allocatedtickets" class="tab-pane fade in active">
    <h5><u>Allocated</u></h5>
