...
<p>
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="px-2 active"><a class="btn btn-warning btn-sm" href="<?= Url::to(['/lead/scrapped']) ?>">Scrapped Tickets</a></li>
  ...
  <div class="tab-content">
    ...
    <div style="display: contents;" id="scrappedtickets" class="tab-pane fade in active">
    <h5><u>Scrapped</u></h5>
